            ...
            <section id="nav">
                <div className="py-4 mx-4 lg:mx-20  flex  justify-between items-center">
                    ...
                    <div className=" lg:flex-1 flex  justify-end">
                        <div className="flex">
                            <div className="bg-[#F5F2FF] sm:block hidden p-2 md:p-3 rounded-full cursor-pointer">
                                <BiSearch className=' text-xs sm:text-base text-gray-700' />
                            </div>
                            <div className="bg-[#FFF3EC] sm:block hidden p-2 md:p-3 rounded-full mx-4 cursor-pointer">
                                <BiUser className=' text-xs sm:text-base text-gray-800' />
                            </div>
                            <div className="bg-[#ECFBFF] sm:block hidden p-2 md:p-3 pt-[14px] rounded-full cursor-pointer">
                                <FiHeart className=' text-xs sm:text-base text-gray-700' />
                            </div>
                            <div className="bg-[#FEEFD0] p-3 md:p-3 pt-[14px] rounded-full cursor-pointer mx-4">
